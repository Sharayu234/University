    ...
    return (
        <div className='about'>
            ...
            <div className="about-right">
                ...
                <p>Embark on a transformative educaional journey with our
                ...
                <p>Whether you aspire to become a teacher, administrator,
                    counselor, or educationall leader, our diverse range of programs
                    offers the perfec pathway to achieve your goals and unlock your
